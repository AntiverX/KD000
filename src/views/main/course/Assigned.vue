  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="120px" style="width: 400px; margin-left:50px;">
        ...
        <el-row>
          <el-form-item label="排课周" prop="comment">
            <el-select
              v-model="temp.week"
              style="width: 280px;"
              placeholder="请选择"
        ...
        <el-form-item label="排课时段" prop="comment">
          <el-select
...
export default {
  ...
  methods: {
    ...
    getCurrentCourse() {
      getAssigned(this.listQuery).then(response => {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          createAssigned(this.temp).then(response => {
